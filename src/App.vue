<template>
  <b-container class="mt-1 mb-5">
    ...
    <p>
      ...
      Absagen kannst du den Termin mit dem Link aus der E-Mail deiner alten Buchung. Solange du den alten Termin nicht abgesagt hast, kannst du auch keinen neuen Termin buchen.
    </p>
